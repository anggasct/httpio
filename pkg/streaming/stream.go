...
func Stream(r *goclient.Response, handler func([]byte) error, opts ...StreamOption) error {
	if r.Body == nil {
...
// streaming stops and the error is returned.
func StreamLines(r *goclient.Response, handler func([]byte) error, opts ...StreamOption) error {
	if r.Body == nil {
		return errors.New("response body is nil")
	}
	defer r.Body.Close()
...
func StreamJSON(r *goclient.Response, handler func(json.RawMessage) error, opts ...StreamOption) error {
...
//	    return nil
//	})
func StreamInto(r *goclient.Response, handler interface{}, opts ...StreamOption) error {
...
func GETSTREAM(c *goclient.Client, ctx context.Context, path string, handler func([]byte) error, opts ...StreamOption) error {
...
func GETStreamLines(c *goclient.Client, ctx context.Context, path string, handler func([]byte) error, opts ...StreamOption) error {
	resp, err := c.GET(ctx, path)
	if err != nil {
		return err
	}
...
func GETStreamJSON(c *goclient.Client, ctx context.Context, path string, handler func(json.RawMessage) error, opts ...StreamOption) error {
	resp, err := c.GET(ctx, path)
	if err != nil {
		return err
	}
...
func GETStreamInto(c *goclient.Client, ctx context.Context, path string, handler interface{}, opts ...StreamOption) error {
	resp, err := c.GET(ctx, path)
	if err != nil {
		return err
	}
...
// EventSourceHandler is a function that processes Server-Sent Events
type EventSourceHandler func(event, data string) error

// GETSSE is a convenience method for making a GET request to a Server-Sent Events endpoint
func GETSSE(c *goclient.Client, ctx context.Context, path string, handler EventSourceHandler) error {
	resp, err := c.GET(ctx, path)
	if err != nil {
		return err
	}
